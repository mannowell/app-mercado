...
// Configuração global para testes de componentes UI
config.global = {
  ...config.global,
  plugins: [],
  components: {},
...
// Configuração de mocks para testes de componentes UI
...
// Configuração de variáveis de ambiente para testes de componentes UI
